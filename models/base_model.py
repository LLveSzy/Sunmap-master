...
class BaseModel(ABC):
    ...
    def save_checkpoint(self):
        dir_checkpoint = os.path.join(f'./checkpoints/', self.opt.exp)
        try:
        ...
        torch.save(self.model.state_dict(),
                   os.path.join(dir_checkpoint, f'{self.opt.checkpoint_name}_{time.strftime("%Y-%m-%d")}.pth'))
        print(f'Checkpoint {self.opt.checkpoint_name} saved !')

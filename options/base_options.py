...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--model', type=str, default='segnet', help='chooses which model to use. [segnet | semiseg]')
        parser.add_argument('--input_dim', type=int, default=64, help='input dimension of model')
